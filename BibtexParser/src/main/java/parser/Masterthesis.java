 ...
 */
class Masterthesis extends Record {
    private final static RecordType recordType = RecordType.MASTERSTHESIS;
    ...
    public Masterthesis setOptionalFields(TreeMap<FieldType, String> optionalFields) {
    ...
    public Masterthesis setMandatoryFields(TreeMap<FieldType, String> mandatoryFields) {
